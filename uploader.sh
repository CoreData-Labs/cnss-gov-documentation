...
function main() { # Define the main function that contains all script logic
	...
	CHECK_INTERVAL_SECONDS=5       # Wait 5 seconds between each repository check
	MIN_WAIT_SECONDS=15            # Force push at least every 15 seconds (15 sec)
	MIN_FILE_CHANGE_THRESHOLD=1    # Push early if 1+ files have changed
